...
--
-- Name: projects; Type: TABLE; Schema: public; Owner: evawiedmann
--
...
ALTER TABLE public.projects OWNER TO evawiedmann;

--
-- Name: projects_id_seq; Type: SEQUENCE; Schema: public; Owner: evawiedmann
--
...
ALTER TABLE public.projects_id_seq OWNER TO evawiedmann;

--
-- Name: projects_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: evawiedmann
--
...
--
-- Name: projects id; Type: DEFAULT; Schema: public; Owner: evawiedmann
--
...
--
-- Data for Name: projects; Type: TABLE DATA; Schema: public; Owner: evawiedmann
--
...
--
-- Name: projects_id_seq; Type: SEQUENCE SET; Schema: public; Owner: evawiedmann
--
...
SELECT pg_catalog.setval('public.volunteers_id_seq', 100, true);


--
-- Name: projects projects_pkey; Type: CONSTRAINT; Schema: public; Owner: evawiedmann
--
